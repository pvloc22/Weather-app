...
class WeatherSavedBloc extends Bloc<WeatherSavedEvent, WeatherSavedState> {
  ...
  Future<void> _onLoadSavedWeathers(LoadSavedWeathersEvent event, Emitter<WeatherSavedState> emit) async {
  ...
  Future<void> _onDeleteSavedWeather(DeleteSavedWeatherEvent event, Emitter<WeatherSavedState> emit) async {
    try {
      final prefs = await SharedPreferences.getInstance();
      final key = '${_storageKey}${event.cityName.toLowerCase()}';
  ...
  Future<void> _onClearAllSavedWeathers(ClearAllSavedWeathersEvent event, Emitter<WeatherSavedState> emit) async {
    try {
      final prefs = await SharedPreferences.getInstance();
